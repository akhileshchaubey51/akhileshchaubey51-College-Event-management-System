...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!preg_match("/@gehu\.ac\.in$/", $email)) {
        $msg = "Only college email addresses (@gehu.ac.in) are allowed.";
    } else {
        ...
        if ($stmt->execute()) {
            ...
            $msg = "Error: Could not save your message.";
        }
        $stmt->close();
    }
}
        ...
        <div class="contact-content">
            <div class="left">
                ...
                <p>
                    ...
                    <br><br>
                    <i class="fas fa-phone"></i> Tel: 18XXXXXXX00<br>
                    <i class="fas fa-envelope"></i> Email: info@gehu.ac.in<br>
                    <i class="fas fa-clock"></i> Open: 9 AM - 4 PM (Mon-Sat)
                </p>
            </div>
            <div class="right">
