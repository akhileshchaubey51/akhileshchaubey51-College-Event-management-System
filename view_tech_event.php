...
$stmt = $conn->prepare("SELECT * FROM tech_events WHERE id = ?");
...
<html>
<head>
    <title><?= htmlspecialchars($event['event_name']) ?> - Tech Event</title>
    <style>
...
<body>
    ...
    <p><strong>Description:</strong><br><?php echo nl2br(htmlspecialchars($event['description'])); ?></p>
        <a class="btn" href="register_event.php?event_id=<?= $event['id'] ?>&type=Tech">Register Now</a>
    </div>
</body>
</html>
