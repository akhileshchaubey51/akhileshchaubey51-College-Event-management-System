...
try {
    $stmt = $dbh->prepare("SELECT * FROM tech_events WHERE event_name = :event_name LIMIT 1");
...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($event['event_name']); ?> - Tech Event</title>
    <style>
        body {
...
<div class="container">
    ...
    <a class="back-link" href="tech-events.php">← Back to Tech Events</a>
</div>
</body>
</html>
